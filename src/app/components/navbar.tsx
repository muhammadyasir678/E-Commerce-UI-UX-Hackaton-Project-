...
import user from "/public/Vector (12).png";
import search from "/public/icn settings icn-xs (6).png";
import cart from "/public/icn settings icn-xs (7).png";
import mail from "/public/icn settings icn-xs (8).png";
  ...
  return (
    <div className="lg:w-[1437px] lg:h-[58px] w-full h-[532px] lg:absolute lg:top-[70px]">
      <div className="absolute left-[38px] flex items-center gap-[10px]">
        <h3 className="font-Montserrat font-semibold leading-[55px] text-[24px] sm:hiddden">
          Bandage
        </h3>
      </div>
      ...
      <div className="w-[1155px] h-[58px] absolute left-[265px] hidden lg:block">
        <div className="w-[361px] h-[25px] absolute top-[20.5px] flex gap-[15px]">
          <ul className="font-Montserrat font-semibold text-[14px] text-[#737373] gap-[15px] leading-[13px] flex justify-center">
            <li>
              <Link href="/">Home</Link>
            </li>
            <li>
        ...
        <div className="w-[324px] h-[54px] absolute top-[2px] left-[832px] flex justify-between items-center">
          <div className="w-[166px] h-[54px] p-[15px] flex items-center gap-[5px]">
            ...
            <span className="w-[119px] h-[24px] font-Montserrat font-semibold text-[14px] leading-[22px] text-[#23A6F0]">
              Login / Register
            </span>
          </div>
