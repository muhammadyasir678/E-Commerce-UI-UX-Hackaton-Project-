...
import phone from "/public/icn settings icn-xs.png";
import mail from "/public/icn settings icn-xs (1).png";
import insta from "/public/icn settings icn-xs (2).png";
import yout from "/public/icn settings icn-xs (3).png";
import fb from "/public/icn settings icn-xs (4).png";
import twit from "/public/icn settings icn-xs (5).png";

export default function GreenHeader() {
  return (
    <div className="lg:block hidden w-[1437px] h-[58px] bg-[#23856D]">
